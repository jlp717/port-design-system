...
description: Literal visual transplant for Next.js targets. Supports two invocation modes: local source repo (FORMA A) and direct public URL source (FORMA B with --url). DESIGN is copied from source/reference, TEXT remains from target business content.
---
